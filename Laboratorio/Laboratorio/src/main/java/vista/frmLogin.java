    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (txtUsuario.getText().trim().isEmpty() || txtContrasena.getText().trim().isEmpty()) {
            ...
            try {
                ...
                linea.setNombreLinea(txtUsuario.getText().trim());
                // Recuperación de información a través de otro objeto
                linea = linea.getBuscarInformacionLineasPorNombre(linea);
                if (txtContrasena.getText().equals(linea.getEstatusLinea()) && 
                    txtUsuario.getText().equals(linea.getNombreLinea())) {
